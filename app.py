...
def network_graph(yearRange, AccountToSearch):
    ...
    edge1 = pd.read_csv('/Users/d062864/Documents/01_code/network-visualization/edge1.csv')
    node1 = pd.read_csv('/Users/d062864/Documents/01_code/network-visualization/node1.csv')
